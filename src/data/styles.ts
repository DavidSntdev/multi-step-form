...
export const pClass = "text-lg pt-3 pb-5 text-[var(--colorCoolGray)]";

export const labelStep1 = "text-[var(--colorMarineBlue)] font-medium text-base";

export const inputStep1 =
  "px-5 py-2 border border-[var(--colorLightGray)] rounded-md";
